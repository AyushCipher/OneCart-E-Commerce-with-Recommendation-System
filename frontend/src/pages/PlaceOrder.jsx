...
function PlaceOrder() {
  ...
  // ML Tracking
  const { trackPurchase } = useMLTracking(userData?._id)
      ...
      switch(method){
        ...
        case 'razorpay':
          ...
          if(resultRazorpay.data){
            ...
            // ML Tracking: Track purchase after payment verification (handled in initPay handler)
            toast.success("Order Placed")
            setLoading(false)
          }
        break;
